...
export const AREAS: Area[] = [
  ...
  },
  {
    ...
    hours: { day1: '10:30〜16:30', day2: '10:30〜16:00' },
    map: {
      image: '/maps/east8out.webp',
      // 上の広い区画は行と列で4分割、そこから下へ伸びる細い帯は行だけで3分割する
      cells: [
        {
          id: 'A1',
          polygon: [
  ...
  },
  {
    ...
    map: {
      ...
      // 帯がカーブしていて格子では追従できないため、行方向に手作業で3分割する
      cells: [
        {
          id: 'A',
          polygon: [
