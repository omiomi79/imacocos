...
const ja = {
  ...
  'post.areaNotice':
    '黄色の部分はあくまで想定されるエリアであり、当日の状況により異なる場合がございます。おおよその場所として指定するためにご使用ください。',
  'post.status': '現在の状態',
  'post.note': 'ひとこと',
  'post.xId': 'XのID',
  'post.xIdHelp':
...
const en: Record<MessageKey, string> = {
  ...
  'post.areaNotice':
    'The yellow zones are approximate and may differ on the day. Please use them to indicate a rough location.',
...
const zh: Record<MessageKey, string> = {
  ...
  'post.areaNotice':
    '黄色部分仅为预计区域，当天情况可能有所不同。请将其作为大致位置使用。',
  'post.status': '当前状态',
  'post.note': '留言',
  'post.xId': 'X的账号',
...
const ko: Record<MessageKey, string> = {
  ...
  'post.areaNotice':
    '노란색 부분은 어디까지나 예상 구역이며 당일 상황에 따라 다를 수 있습니다. 대략적인 위치를 나타내는 용도로 사용해 주세요.',
  'post.status': '현재 상태',
  'post.note': '한마디',
  'post.xId': 'X 아이디',
...
const es: Record<MessageKey, string> = {
  ...
  'post.areaNotice':
    'Las zonas amarillas son aproximadas y pueden variar el mismo día. Úsalas para indicar una ubicación aproximada.',
...
const fr: Record<MessageKey, string> = {
  ...
  'post.areaNotice':
    "Les zones en jaune sont approximatives et peuvent différer le jour même. Utilisez-les pour indiquer un emplacement approximatif.",
